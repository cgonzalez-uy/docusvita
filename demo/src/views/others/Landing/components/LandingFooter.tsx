        ...
        <div id="footer" className="relative z-20">
            <Container className="relative">
                <div className="py-10 md:py-40">
                    <AuroraBackground className="rounded-3xl" auroraClassName="rounded-3xl">
                        <motion.div
                        ...
                        >
                            ...
                            <p className="mt-4 max-w-[400px] mx-auto">Build modern, scalable applications effortlessly with DocusVita. Take your project to the next level today!</p>
                            <div className="mt-6">
